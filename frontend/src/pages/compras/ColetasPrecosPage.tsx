    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/50 overflow-hidden">
        <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-600 flex flex-wrap items-end gap-4">
          ...
          <button
            type="button"
            onClick={() => void atualizarGrade()}
            disabled={loading}
            className="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-600 text-sm font-medium transition shrink-0 disabled:opacity-50"
            title="Recarregar a grade e as opções de filtro (código/descrição)"
          >
            <svg
